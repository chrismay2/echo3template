...
public class MyComponentPeer extends AbstractComponentSynchronizePeer {
    ...
    private static final Service MYCOMPONENT_SERVICE = JavaScriptService.forResource("My.Component", 
            "js/MyComponent.js");
    
    static {
        WebContainerServlet.getServiceRegistry().add(MYCOMPONENT_SERVICE);
    }
    ...
    public void init(Context context, Component component) {
        ...
        serverMessage.addLibrary(MYCOMPONENT_SERVICE.getId());
    }    
}
